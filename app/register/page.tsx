  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (selectedRole === "artist") {
        ...
        const artistPayload = (await artistResponse.json()) as { ok: boolean; message?: string };

        if (!artistResponse.ok || !artistPayload.ok) {
          setErrorMessage(artistPayload.message ?? "Der Künstleraccount konnte nicht gespeichert werden.");
          return;
        }
      }
